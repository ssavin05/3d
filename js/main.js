...
function pintarLateral() {
  ...
  if (esStaff()) {
    ...
    html += [
      { ruta: "/admin", ico: "panel", txt: t("admin.resumen"), admin: false },
      { ruta: "/admin/reservas", ico: "calendario", txt: t("admin.reservas"), admin: false },
      { ruta: "/admin/usuarios", ico: "usuarios", txt: t("admin.usuarios"), admin: false },
      { ruta: "/admin/espacios", ico: "edificio", txt: t("admin.espacios"), admin: true },
      { ruta: "/admin/apariencia", ico: "ajustes", txt: "Qué se ve", admin: true },
      { ruta: "/admin/estadisticas", ico: "grafica", txt: t("admin.estadisticas"), admin: true },
