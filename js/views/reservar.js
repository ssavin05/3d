...
import { selectorDias, rejillaHorarios, resumenPrecio } from "./componentes.js";
...
const st = { espacio: null, fecha: isoFecha(), bloque: null, disponibilidad: [], asistentes: 1, notas: "", cupon: null, cotizacion: null };
...
export async function render(contenedor, ctx) {
  ...
  if (!espacio.reservable || !["OF-A", "OF-B", "OF-C", "OF-D"].includes(String(espacio.codigo || "").toUpperCase())) {
    ...
    <div class="vista-scroll reservar">
      <div class="vista-contenido">
        ...
        <section class="seccion mt-6">
          ...
          <div id="rv-dias">${raw(selectorDias(st.fecha))}</div>
